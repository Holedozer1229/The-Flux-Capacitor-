...
- **Asynchronous Merge Miner**: Bitcoin, RollPoW, and Tetra-PoW merge mining with quantum-temporal proof-of-work using Stratum protocol (`async_merge_miner.py`, `MINING.md`).
